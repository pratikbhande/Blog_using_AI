...
def fetch_ai_news():
    ...
    """
    api_key = "gnews api key"  # Replace with your actual GNews API key
    url = f"https://gnews.io/api/v4/search?q=ai&lang=en&country=us&max=5&sortby=publishedAt&apikey={api_key}"
    try:
